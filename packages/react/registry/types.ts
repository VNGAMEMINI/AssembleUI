...
export type AUIComponentCategory =
  | "data"
  | "feedback"
  | "forms"
  | "layout"
...
export interface AUIRegistryEntry<
  Layer extends AUIRegistryLayer,
  Category extends
...
export type AUIAnyRegistryEntry =
  | AUIRegistryEntry<"component", AUIComponentCategory>
  | AUIRegistryEntry<"pattern", AUIPatternCategory>
  | AUIRegistryEntry<"template", AUITemplateCategory>;
